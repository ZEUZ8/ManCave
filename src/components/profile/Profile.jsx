          ...
          <div className="flex flex-col items-center ">
            ...
            <div class="w-full">
              <div className="flex justify-center">
                <a className="active:scale-95 w-full flex justify-center items-center px-4 py-2 text-sm font-medium text-center text-white bg-blue-700 rounded-lg hover:bg-blue-800 focus:ring-1 focus:outline-none focus:ring-blue-300 dark:bg-blue-600 dark:hover:bg-blue-700 dark:focus:ring-blue-800"
                 onClick={handleClick}
                >
                  Book Now
                </a>
